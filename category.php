...
<head>
  ...
  <title>Amoblando - Categoria</title>
<!-- 
Cafe House Template
        ...
        <div class="row">
          <div class="tm-top-header-inner">
            <div class="tm-logo-container">
              ...
              <h1 class="tm-site-name tm-handwriting-font">Amoblando</h1>
            </div>
    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Categoria&nbsp;&nbsp;<img src="img/header-line.png" alt="Line" class="tm-header-line"></h2>
          <h2 class="gold-text tm-welcome-header-2">Amoblando</h2>
          <p class="gray-text tm-welcome-description">- <span class="gold-text">Categorias</span>-</p>
          <a href="#main" class="tm-more-button tm-more-button-welcome">Leer más</a>
        </div>
        <img src="img/index_principal.png" alt="Table Set" class="tm-table-set img-responsive">
      </div>      
    </section>
      ...
      <div class="container" id="main">
        <section class="tm-section tm-section-margin-bottom-0 row">
          <div class="col-lg-12 tm-section-header-container">
            <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="img/House-Icon.png" alt="Logo" class="tm-site-logo"> Popular Items</h2>
        ...
        <section class="tm-section">
          <div class="row">
            <div class="col-lg-12 tm-section-header-container">
              <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="img/House-Icon.png" alt="Logo" class="tm-site-logo"> Daily Menu</h2>
              <div class="tm-hr-container"><hr class="tm-hr"></div> 
            </div>  
          </div>          
          <div class="row">
